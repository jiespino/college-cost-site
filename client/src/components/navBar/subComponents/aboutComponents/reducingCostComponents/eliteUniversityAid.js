...
function EliteUniversityAid() {
  ...
  return (
    ...
    <div>
        ...
        <li>
            <p>Elite private universities <a href={needBasedFinAidLink} target="_blank" rel="noreferrer">(here is a partial list)</a> offer 
            very generous need based aid for lower-middle income students.
            If a student comes from a lower-middle income family, the best method for keeping their costs low is to get
             accepted into one of these universities, as they can have most 
            of their tuition covered by the university. The amount of aid and income cut-offs vary by university. 
            ...
            at an increased rate. <a href={needBasedFinAidDetailsLink} target="blank" rel="noreferrer">Here are more details on this type of university aid</a>.
        </p>
        <p>
            ...
            on-average, but when controlling for other factors such as work ethic/test scores/one's networking skills <a href={washPostPrivUnivRiskReward} target="_blank" rel="noreferrer">
            ...
            Because private university tuition now costs a small fortune, it would be wise to take these factors into account.
